var moduleTicketrServices = angular.module("services.Ticket", [
  "tokenSystem",
  "services.User",
]);

moduleTicketrServices.service("ticketServices", [
  "$http",
  "tokenSystem",
  "$timeout",
  "serverHost",
  ...
  function (
    ...
    return {
      ...
      all: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/allnew",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      addUpRequest: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/index2",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      addDownRequest: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/index3",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      approvedTicket: function (data) {
        console.log(
          "[Ticket Services] => Approve Ticket Id: " + data.ticket.idTicket,
        );
        console.log(data);
        return $http
          .post(
            serverHost + serverBackend + "Ticket/approve",
            data,
            serverHeaders,
          )
      ...
      seBillingInitiate: function (data) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/billingInitiate",
            data,
            serverHeaders,
          )
          .then(function mySucess(response) {
      ...
      requestCancelTicket: function (data) {
        console.log(
          "[Ticket Services] => Request Cancel of Ticket Id: " +
            data.ticket.idTicket,
        );
        console.log(data);
        return $http
          .post(
            serverHost + serverBackend + "Ticket/requestCancel",
            data,
            serverHeaders,
          )
          .then(function mySucess(response) {
      ...
      rejectRequestCancelTicket: function (data) {
        console.log(
          "[Ticket Services] => Reject Cancel Request of Ticket Id: " +
            data.ticket.idTicket,
        );
        console.log(data);
        return $http
          .post(
            serverHost + serverBackend + "Ticket/rejectRequestCancel",
            data,
            serverHeaders,
          )
          .then(function mySucess(response) {
      ...
      cancelTicket: function (data) {
        console.log(
          "[Ticket Services] => Cancel Ticket Id: " + data.ticket.idTicket,
        );
        console.log(data);
        return $http
          .post(
            serverHost + serverBackend + "Ticket/cancelTicket",
            data,
            serverHeaders,
          )
          .then(function mySucess(response) {
      ...
      updateTmpTicket: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/updateTmpTicket",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      rejectedChOrCanTicket: function (id, value) {
        var responseMsg =
          value == 1
            ? "un Cambio de envio rechazado"
            : "una Cancelacion rechazada";
        console.log(
          "[TicketService]=>[rejectedChOrCanTicket]: Aplicando los cambios sobre " +
            responseMsg +
            " en el ticket N#: " +
            id,
        );
      ...
      completeTicketRefund: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/completeTicketRefund",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      changueStatus: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/changueStatus",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      addDeliveryCompany: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/addDeliveryCompany",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      setTicketDelivered: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/setTicketDelivered",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      updateUpRequest: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/update",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      setKeysEnableDisable: function (ticket) {
        console.log(
          "Setting Keys Enable or Disable ticket service :: Triggered",
        );
        //console.log(tkUpdateData);
        return $http
          .post(
            serverHost + serverBackend + "Ticket/setKeysEnableDisable",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      tmpDeliveryData: function (ticket) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/addTmpDeliveryOrCancelData",
            ticket,
            serverHeaders,
          )
          .then(
      ...
      ticketById: function (ticketID) {
        ...
        console.log(
          "[Service] => [ticketById] => Ticket a buscar: " + ticketID,
        );
        return $http({
          method: "GET",
      ...
      billingFileUploaded: function (ticketID) {
        var ticketId = ticketID;
        console.log(
          "[Service] => [billingFileUploaded] => Ticket a buscar: " + ticketID,
        );
        return $http({
          method: "GET",
          url:
            serverHost + serverBackend + "Ticket/billingUploaded/" + ticketID,
        }).then(
          function mySuccess(response) {
            return response;
          },
      ...
      ticketByToken: function (ticketToken) {
        ...
        return $http({
          method: "GET",
          url:
            serverHost + serverBackend + "Ticket/ticketByToken/" + ticketToken,
        }).then(
          function mySuccess(response) {
      ...
      checkTicketBeforeCancel: function (ticketID) {
        ...
        return $http({
          ...
          url:
            serverHost +
            serverBackend +
            "Ticket/verificateTicketBeforeCancel/" +
            ticketID,
        }).then(
          function mySuccess(response) {
            rsJsonTicket = response.data;
      ...
      verifyTicketsByIdUser: function (idUser) {
        console.log(
          "[Ticket Services] => verificar si un usuario tiene un pedido asociado: " +
            idUser,
        );
        return $http({
          method: "GET",
          url:
            serverHost +
            serverBackend +
            "Ticket/verificateTicketByIdUser/" +
            idUser,
        }).then(
          function mySuccess(response) {
            return response;
      ...
      verifyTicketsByIdUserDepto: function (idUser, idDepto) {
        console.log(
          "[Ticket Services] => verificar si un usuario y depto tiene un pedido asociado: " +
            idUser,
        );
        return $http({
          method: "GET",
          url:
            serverHost +
            serverBackend +
            "Ticket/verificateTicketByidUserDepto/" +
            idUser +
            "/" +
            idDepto,
        }).then(
      ...
      createMPLink: function (data) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "MercadoLibre/crearEnlaceMercadoPago",
            data,
            serverHeaders,
          )
          .then(
      ...
      addPayment: function (data) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "MercadoLibre/addPayment",
            data,
            serverHeaders,
          )
          .then(
      ...
      updatePayment: function (data) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "MercadoLibre/updatePayment",
            data,
            serverHeaders,
          )
          .then(
      ...
      uploadTicketFiles: function (file, idTicketKf) {
        ...
        return $http
          .post(serverHost + serverBackend + "Ticket/uploadFile", fd, {
      ...
      addUploadedTicketFile: function (data) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/addUploadedTicketFile",
            rsTicket,
            serverHeaders,
          )
          .then(function mySuccess(response) {
      ...
      deleteTicketFiles: function (data) {
        ...
        console.log(
          "[Ticket Services] => Delete Ticket Uploaded File from server ",
        );
        return $http
          .post(
            serverHost + serverBackend + "Ticket/deleteFile",
            rsTicket,
            serverHeaders,
          )
          .then(function mySuccess(response) {
      ...
      deleteUploadedTicketFile: function (data) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/deleteUploadedTicketFile",
            rsTicket,
            serverHeaders,
          )
          .then(function mySuccess(response) {
      ...
      sendBillingMailNotification: function (idTicket, filename) {
        ...
        return $http({
          ...
          url:
            serverHost +
            serverBackend +
            "Ticket/sendPostBillingMailNotification/" +
            idTicket +
            "/" +
            filename,
        })
      ...
      ticketInitialDeliveryActiveByDeptoId: function (data) {
        ...
        return $http
          .post(
            serverHost +
              serverBackend +
              "Ticket/ticketInitialDeliveryActiveByDeptoId",
            data,
            serverHeaders,
          )
          .then(
      ...
      updateTicketKeychain: function (data) {
        ...
        return $http
          .post(
            serverHost + serverBackend + "Ticket/updateTicketKeychain",
            rsKey,
            serverHeaders,
          )
          .then(function mySuccess(response) {
      ...
      setIsTechnicianAssigned: function (data) {
        console.log(
          "[Ticket Service][setIsTechnicianAssigned]---> Ticket Set isTechnicianAssigned to TRUE",
        );
        return $http
          .post(
            serverHost + serverBackend + "Ticket/IsTechnicianAssigned",
            data,
            serverHeaders,
          )
          .then(
