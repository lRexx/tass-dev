                        ...
                        $scope.new.ticket.keys = [];
                            ...
                            /*-- DELIVERY METHOD --*/
                                ...
                                if (obj.delivery.idTypeDeliveryKf=='2'){
                                    ...
                                    $scope.new.ticket.mail +='</tr><tr>';
                                    $scope.new.ticket.mail += '<td align="center" valign="middle" colspan="4" style="background-color: #d9edf7;color: #31708f;border-bottom: 1px solid transparent !important;border-left: 1px solid transparent !important;border-right: 1px solid transparent !important;border-top: 0px;border-radius: 0px 0px 40px 40px;border-color: #bce8f1;"><ul style="padding-right: 15px;font-size: 0.9vw !important;">';
                                    $scope.new.ticket.mail += '<li style="text-align:justify;padding-right: 15px;">todos los pedidos autorizados y pagados antes de los dias lunes a las 12 hs serán etregados por la empresa de logística los dias martes de 15 a 21 hs (con un segundo intento de entregalos dias miércoles)</li>';
                                    $scope.new.ticket.mail += '<li style="text-align:justify;padding-right: 15px;">todos los pedidos autorizados y pagados antes de los dias juebes a las 12 hs serán repartidos por la empresa de logística los dias viernes de 15 a 21 hs (con un segundo intento de entregalos dias lunes)</li>';
