 ...
 * Products Controller
 **/
var tickets = angular.module("module.Tickets", [
  "tokenSystem",
  "angular.filter",
  "services.Customers",
  "services.Keys",
...
tickets.controller(
  ...
  function (
    ...
    $scope.select = {
      admins: { selected: undefined },
      buildings: { selected: undefined },
      depto: undefined,
      floor: undefined,
    ...
    $scope.tenant = {
      namesTenant: null,
      addressTenant: null,
      movilPhoneTenant: null,
      localPhoneTenant: null,
      emailTenant: null,
    };
    $scope.ticket = {
    ...
    $scope.remove = {
      info: { idUser: null, idDepartmentKf2: null, idTypeTenant: null },
    };
      ...
      switch ($scope.swMenu) {
        case "closeWindow":
          if (confirm == 0) {
            if ($scope.isNewTenant == true || $scope.isNewAttendant == true) {
              $scope.mess2show =
                "Se perderan todos los datos cargados para el registro actual, esta seguro que desea cancelar?";
            } else {
              $scope.mess2show =
                "Se perderan todos las modificaciones realizadas en el registro actual, esta seguro que desea cancelar la modificacion?";
            }
        ...
        case "closeRequest":
          if (confirm == 0) {
            ...
            $timeout(function () {
              $scope.mess2show =
                "Desea realizar un nuevo pedido.     Confirmar?";
            ...
            $timeout(function () {
              if (
                ($scope.sysLoggedUser.idProfileKf == "4" &&
                  $scope.sysLoggedUser.idTypeTenantKf == null) ||
                $scope.sysLoggedUser.idProfileKf == "1" ||
                $scope.sysLoggedUser.idProfileKf == "3" ||
                $scope.sysLoggedUser.idProfileKf == "5"
              ) {
        ...
        case "checkReason":
          if (confirm == 0) {
            ...
            $timeout(function () {
              $scope.mess2show =
                "Desea continuar con el pedido.     Confirmar?";
              $("#showModalRequestDown").modal({
                backdrop: "static",
                keyboard: false,
              });
            ...
            inform.add(
              "Por favor continue con el proceso de baja para completar la solicitud.",
              {
                ttl: 15000,
                type: "info",
              },
        ...
        case "tup":
          if (confirm == 0) {
            $scope.ticketUp = obj;
            $scope.mess2show =
              "Esta seguro que desea realizar el pedido de alta.     Confirmar?";
        ...
        case "tdown":
          if (confirm == 0) {
            ...
            $scope.mess2show =
              "Esta seguro que desea realizar el pedido de baja.     Confirmar?";
    ...
    $scope.pasos3 = ["PASO 1: DATOS", "PASO 2: DATOS DEL SERVICIO"];
    $scope.pasos4 = [
    ...
    $scope.incrementStep = function () {
      ...
      if ($scope.hasNextStep()) {
        console.log(
          "$scope.getCurrentStepIndex: " + $scope.getCurrentStepIndex(),
        );
        var stepIndex = $scope.getCurrentStepIndex();
        ...
        if ($scope.fSwitch == "n") {
          if (nextStep == $scope.pasos.length - 1) {
            ...
            nextStep == 2 &&
            $scope.ticket.optionTypeSelected.name == "building" &&
            $scope.ticket.radioButtonBuilding != "1" &&
            $scope.ticket.radioButtonBuilding != "2" &&
            $scope.ticket.radioButtonBuilding != "3"
          ) {
          ...
          $scope.ticket.cost.service != undefined &&
      ...
      switch ($scope.stepIndexTmp) {
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  if ($scope.customerCosts) {
                    //$scope.attendantFound &&  #removed by request by Leandro 26/01/2023
                    if (
                      $scope.ticket.radioButtonBuilding == "4" &&
              ...
              if (
                ...
                if ($scope.customerCosts) {
                  //$scope.attendantFound &&  #removed by request by Leandro
                  $scope.formValidated = true;
                } else {
                  $scope.formValidated = false;
                }
        ...
        case 1:
          ...
          if ($scope.fSwitch == "n" && $scope.sysLoggedUser.idProfileKf != 0) {
            ...
            if (
              ($scope.ticket.optionTypeSelected.name == "department" &&
                ($scope.ticket.radioButtonDepartment == null ||
                  $scope.ticket.radioButtonDepartment == undefined ||
                  $scope.selectedRequestKeyOwnerUser == null ||
                  $scope.selectedRequestKeyOwnerUser == undefined)) ||
              ($scope.ticket.optionTypeSelected.name == "building" &&
                ($scope.ticket.radioButtonBuilding == undefined ||
                  $scope.ticket.radioButtonBuilding == null)) ||
            ...
            $scope.fSwitch == "d" &&
            $scope.sysLoggedUser.idProfileKf != 0
          ) {
            console.log($scope.ticket);
            //PASO 2: LLAVEROS DE LA SOLICITUD
            if (
        ...
        case 2:
          ...
          if ($scope.fSwitch == "n" && $scope.sysLoggedUser.idProfileKf != 0) {
            console.info(
              "ENTRO AL CASE 3 : ALTA DE LLAVE - PASO 3: MÉTODO DE ENVÍO O ENTREGA",
            );
            if (
              $scope.ticket.delivery.idTypeDeliveryKf == undefined ||
              ...
              if ($scope.ticket.delivery.idTypeDeliveryKf == "1") {
                ...
                if (
                  (($scope.ticket.delivery.whoPickUp == null ||
                    $scope.ticket.delivery.whoPickUp.idUser != undefined) &&
                    ($scope.ticket.delivery.deliveryTo == null ||
                      $scope.ticket.delivery.deliveryTo.idUser == undefined)) ||
                  ($scope.ticket.delivery.whoPickUp.id == 2 &&
                    ($scope.ticket.delivery.deliveryTo == null ||
                      $scope.ticket.delivery.deliveryTo.idUser == undefined)) ||
                  ($scope.ticket.delivery.whoPickUp.id == 3 &&
                    ($scope.ticket.delivery.thirdPerson == null ||
                      $scope.ticket.delivery.thirdPerson.dni == undefined))
                ) {
                  $scope.formValidated = false;
                } else {
                  $scope.formValidated = true;
                ...
                if (
                  (($scope.ticket.delivery.whoPickUp == null ||
                    $scope.ticket.delivery.whoPickUp.idUser != undefined) &&
                    ($scope.ticket.delivery.idDeliveryTo == undefined ||
                  ...
                  ($scope.ticket.delivery.idDeliveryTo == 2 &&
                    ...
                    ($scope.ticket.delivery.otherAddress == null ||
                      $scope.ticket.delivery.otherAddress.streetName ==
                        undefined ||
                      $scope.ticket.delivery.otherAddress.streetNumber ==
                        undefined)) ||
                  ($scope.ticket.delivery.whoPickUp != null &&
                    $scope.ticket.delivery.whoPickUp.id == 2 &&
                    ($scope.ticket.delivery.deliveryTo == null ||
            ...
            console.info(
              "ENTRO AL CASE 3 : BAJA DE LLAVE - PASO 3: LLAVEROS DE LA SOLICITUD",
            );
            if (
              ($scope.ticket.optionTypeSelected.name == "department" &&
                ($scope.ticket.radioButtonDepartment == null ||
        ...
        case 3:
          console.log($scope.ticket);
          if (
            ($scope.fSwitch == "n" || $scope.fSwitch == "d") &&
            $scope.sysLoggedUser.idProfileKf != 0
          ) {
            //PASO 4: MÉTODO DE PAGO
            console.info(
              "ENTRO AL CASE 4 : ALTA DE LLAVE - PASO 4: MÉTODO DE PAGO",
            );
            if (
              $scope.ticket.cost.idTypePaymentKf == null ||
              $scope.ticket.cost.idTypePaymentKf == undefined
            ) {
              if (
                $scope.sysLoggedUser.idProfileKf == 1 &&
                ($scope.ticket.userNotify == null ||
                  $scope.ticket.userNotify == undefined ||
                  $scope.ticket.userNotify == "")
              ) {
                $scope.formValidated = false;
                console.info(" User Admin BSS ");
                console.info(
                  "False because $scope.ticket.userNotify == " +
                    $scope.ticket.userNotify,
                );
              }
    ...
    $scope.switchTab = function (value) {
      ...
      if ($scope.ticket.radioButtonDepartment && value == 2) {
        ...
        console.log(
          "typeTenant: " +
            $scope.ticket.radioButtonDepartment +
      ...
      CustomerServices.getCustomersListByCustomerId(obj.idClient).then(
        function (response) {
          if (response.status == 200) {
            ...
            $scope.buildingList = [];
            inform.add(
              "No hay consorcios asociados a la administracion seleccionada, contacte al area de soporte de BSS.",
              {
                ttl: 5000,
                type: "warning",
              },
        ...
        DepartmentsServices.byIdDireccion(idAddress, idStatusFk).then(
          function (response) {
            if (response.status == 200) {
              ...
              $scope.dptoNotFound = true;
              inform.add(
                "No hay departamentos en esta direccion para ser asociados, contacte al area de soporte de BSS.",
                {
                  ttl: 5000,
                  type: "danger",
                },
          ...
          if (response.status == 200) {
            ...
            $timeout(function () {
              $scope.select.products.selected = {
                ...
                isLicenseDevice: $scope.rsKeyProductsData[0].isLicenseDevice,
    ...
    $scope.lisTenantsByDepto = function (idDepto, idTypeTenant) {
      ...
      if (
        ($scope.sysLoggedUser.idProfileKf == 3 ||
          $scope.sysLoggedUser.idProfileKf == 4 ||
          $scope.sysLoggedUser.idProfileKf == 5 ||
          $scope.sysLoggedUser.idProfileKf == 6) &&
        $scope.sysLoggedUser.idTypeTenantKf != null
      ) {
        DepartmentsServices.listTenant2AssignedDeptoByIdDeptoByTypeTenant(
          idDepto,
          typeTenant,
        ).then(function (response) {
          console.log(
        ...
        DepartmentsServices.listTenantsWithoutKeyAssignedByIdDepto(
          idDepto,
        ).then(function (response) {
          console.log(
            "typeTenant = " +
          ...
          if (response.status == 200) {
            ...
            $scope.messageInform =
              typeTenant == 1 ? $scope.messageInform1 : $scope.messageInform2;
            inform.add(
              "El departamento no presenta" + $scope.messageInform + ".",
              {
                ttl: 3000,
                type: "warning",
              },
            ...
            $scope.listTenantByDepto = [];
            inform.add(
              "Ocurrio un error, contacte al area de soporte de BSS.",
              {
                ttl: 3000,
                type: "danger",
              },
    ...
    $scope.lisTenantsByType = function (idDepto, idTypeTenant) {
      ...
      if (
        ...
        DepartmentsServices.listTenant2AssignedDeptoByIdDepto(idDepto).then(
          function (response) {
            if (response.status == 200) {
              switch (typeTenant) {
                case "1":
                  ...
                  for (var user in response.data.tenant) {
                    if (
                      response.data.tenant[user].idTypeTenantKf == typeTenant
                    ) {
                      $scope.listTenantByType = response.data.tenant;
                      break;
                    }
    ...
    $scope.addDoorOpenList = function (item) {
      if (item.selected) {
        ...
        for (var key in $scope.list_doors) {
          if (
            $scope.list_doors[key].idAccessControlDoor ==
            item.idAccessControlDoor
          ) {
    ...
    $scope.sysCheck4Duplicates = function (value, opt) {
      ...
      if (value) {
        ...
        console.log(opt);
        if (
          ($scope.tenant.new != undefined &&
            $scope.tenant.new.dni != "" &&
            opt == "dni") ||
          ($scope.tenant.new != undefined &&
            $scope.tenant.new.mail != "" &&
            opt == "mail") ||
          ($scope.tenant.update != undefined &&
            $scope.tenant.tmp.dni != value &&
            opt == "dni") ||
          ($scope.tenant.update != undefined &&
            $scope.tenant.tmp.mail != value &&
            opt == "mail") ||
          ($scope.attendant.new != undefined &&
            $scope.attendant.tmp.dni != value &&
            opt == "dni") ||
          ($scope.attendant.new != undefined &&
            $scope.attendant.tmp.mail != value &&
            opt == "mail") ||
          ($scope.attendant.update != undefined &&
            $scope.attendant.tmp.dni != value &&
            opt == "dni") ||
          ($scope.attendant.update != undefined &&
            $scope.attendant.tmp.mail != value &&
          ...
          if (
            (APP_REGEX.check8Numeric.test(value) &&
              APP_REGEX.checkDNI.test(value) &&
              opt == "dni") ||
            (APP_REGEX.checkEmail.test(value) && opt == "mail")
          ) {
              ...
              if (response.status == 200) {
                switch (opt) {
                  case "dni":
                    ...
                    inform.add(
                      "La número de documeto ya se encuentra registrado, Verifique por favor los datos en pantalla, si desea asociarlo tambien a este departamento, para completar el proceso haga click en el boton Asociar.",
                      {
                        ttl: 30000,
                        type: "warning",
                      },
                    ...
                    if (
                      ...
                      $scope.tenant.new.phoneMovilNumberUser =
                        response.data[0].phoneNumberUser;
                      $scope.tenant.new.phonelocalNumberUser =
                        response.data[0].phoneLocalNumberUser;
                    } else {
                  ...
                  case "mail":
                    inform.add(
                      "La dirección de correo ingresada ya se encuentra registrada, sin embargo puede registrar un nuevo usuario con una dirección de correo existente.",
                      {
                        ttl: 30000,
                        type: "warning",
                      },
            ...
            switch (opt) {
              case "dni":
                inform.add(
                  "El documento ingresado no es valido por favor verifique que el número ingresado sea correcto.",
                  {
                    ttl: 30000,
                    type: "danger",
                  },
              ...
              case "mail":
                inform.add(
                  "La dirección de correo ingresada no es valida por favor verifique que la dirección sea correcta.",
                  {
                    ttl: 30000,
                    type: "warning",
                  },
    ...
    $scope.checkDeptoOwner = function (idDepartment) {
      ...
      if (
        ($scope.isNewTenant &&
          ...
          $scope.tenant.new.idTypeTenantKf == 1) ||
        ($scope.isUpdateTenant &&
          $scope.tenant.update.idTypeTenantKf != undefined &&
          $scope.tenant.update.idTypeTenantKf == 1)
      ) {
      ...
      if (
        ...
        ((($scope.attendant.new != undefined &&
          ...
          ($scope.attendant.update != undefined &&
            $scope.attendant.update.idProfileKf == "6")) &&
          $scope.att.ownerOption == 1)
      ) {
        DepartmentsServices.chekDepartamenteOwner(idDepartmentKf).then(
          function (response) {
            console.log(response);
            if (response.status == 200) {
              if (response.data == true) {
                ...
                console.log(
                  "EL DEPTO                        : " +
                    idDepartmentKf +
                    " Ya tiene un propietario Asignado",
                );
    ...
    $scope.checBuildingTitularAttendant = function (idAddress) {
      ...
      //console.log(idDepartment);
      userServices
        .checBuildingTitularAttendant(idAddress)
        .then(function (response) {
          if (response.status == 200) {
            ...
            console.log(
              "EL Consorcio   : " +
                idAddress +
                " Ya tiene un Encargado Titular Asociado",
            );
          } else if (response.data == false) {
            $scope.titularAttendantFound = false;
            console.log(
              "EL Consorcio   : " +
                idAddress +
                " No tiene un Encargado Titular Asociado",
            );
          }
        });
    };
    ...
    $scope.fnAssignDepto = function (userData) {
      DepartmentsServices.assignDepto(userData).then(function (response) {
        if (response.status == 200) {
          inform.add(
            "Departamento Asignado y pendiente por aprobacion por la administracion.",
            {
              ttl: 3000,
              type: "success",
            },
    ...
    $scope.sysRegisterTenantFn = function () {
      ...
      $scope.depto = { department: { idDepartment: null, idUserKf: null } };
      userServices
        .addUser($scope.register)
        .then(function (response_tenantRegister) {
          if (response_tenantRegister.status == 200) {
            console.log("REGISTERED SUCCESSFULLY");
            inform.add(
              "Usuario " +
                $scope.register.user.fullNameUser +
            ...
            userServices
              .findUserByEmail($scope.register.user.dni)
              .then(function (response_tenantFound) {
                if (response_tenantFound.status == 200) {
                  //OWNERS AND TENANTS
                  if (
                    ($scope.register.user.idProfileKf == 3 ||
                      $scope.register.user.idProfileKf == 4 ||
                      $scope.register.user.idProfileKf == 6) &&
                    $scope.register.user.idTypeTenantKf == 1 &&
                    $scope.register.user.idDeparment_Tmp
                  ) {
                    blockUI.start(
                      "Asociando usuario al departamento seleccionado.",
                    );
                    $timeout(function () {
                      $scope.depto.department.idUserKf =
                        response_tenantFound.data[0].idUser;
                      $scope.depto.department.idDepartment =
                        $scope.register.user.idDeparment_Tmp;
                      $scope.depto.department.isApprovalRequired =
                        $scope.sysLoggedUser.idProfileKf == 1 ||
                        $scope.sysLoggedUser.idProfileKf == 4
                          ? false
                          : true;
                    ...
                    if ($scope.sysLoggedUser.idProfileKf == "4") {
                      $timeout(function () {
                        ...
                        $scope.approveDepto(
                          $scope.register.user.idTypeTenantKf,
                          $scope.depto.department.idDepartment,
                          1,
                        );
                      }, 3000);
                    ...
                    $timeout(function () {
                      ...
                      if (
                        $scope.ticket.optionTypeSelected.name == "department" &&
                        ($scope.ticket.radioButtonDepartment == "1" ||
                          $scope.ticket.radioButtonDepartment == "2")
                      ) {
                        $scope.lisTenantsByType(
                          $scope.ticket.idClientDepartament.idClientDepartament,
                          $scope.ticket.radioButtonDepartment,
                        );
                      } else {
                        $scope.getAttendantListFn(
                          $scope.select.buildings.selected.idClient,
                        );
                      }
                      blockUI.stop();
                    }, 3500);
                    ...
                    ($scope.register.user.idProfileKf == 4 ||
                      $scope.register.user.idProfileKf == 5 ||
                      $scope.register.user.idProfileKf == 6) &&
                    $scope.register.user.idTypeTenantKf == 2 &&
                    $scope.register.user.idDepartmentKf
                  ) {
                    if ($scope.sysLoggedUser.idProfileKf == "4") {
            ...
            inform.add(
              "[Error]: " +
                response_tenantRegister.status +
                ", Ocurrio error intenta de nuevo o contacta el area de soporte. ",
              {
                ttl: 5000,
                type: "warning",
      ...
      addressServices.getProvinceIdByName(addressName).then(function (data) {
        ...
        switch (opt) {
          case "main":
            if (
              ((!$scope.addrrSelected &&
                ...
                !$scope.gobApiAddressNotFound) &&
              $scope.customer.new.typeInmueble == "1" &&
              $scope.customer.new.idTipoInmuebleFk == "1"
            ) {
              $scope.getAddressByNameFn(
                $scope.customer.new.nameAddress,
                "main",
              );
            }
          ...
          case "particular":
            if (
              ((!$scope.addrrSelected &&
                $scope.list_particular_address.nameAddress != "") ||
                !$scope.gobApiAddressNotFound) &&
              $scope.customer.particular.typeInmueble == "1"
            ) {
              $scope.getAddressByNameFn(
                $scope.list_particular_address.nameAddress,
                "particular",
    ...
    $scope.searchAddressByNameFn = function (item) {
      $scope.ticket.delivery.thirdPerson.nameAddress =
    ...
    $scope.getAddressByNameFn = function (name, idProvinceFk, opt) {
      ...
      var idProvinceGobARFk =
        idProvinceFk != undefined || idProvinceFk != null ? idProvinceFk : null;
      if (twoNumber_patt.test(name)) {
        addressServices
          .getAddressByName(name, idProvinceGobARFk)
          .then(function (data) {
            if (data != null) {
              switch (opt) {
                case "main":
    ...
    $scope.getServiceCostByCustomerFn = function (data) {
      serviceServices.getServiceCostByCustomer(data).then(function (response) {
        if (response.status == 200) {
          $scope.ticket.cost.service = formatDecimalLatam(
            response.data.technician_service_cost[0].cost,
          );
          $scope.buildingServiceValue = NaN2Zero(
            normalizeDecimal(response.data.technician_service_cost[0].cost),
          );
    ...
    $scope.getDisabledReasonKeyFn = function () {
      UtilitiesServices.getDisabledReasonKey().then(function (response) {
        if (response.status == 200) {
          ...
          inform.add(
            "Tipos de razones para dar de baja no encontradas, contacte al area de soporte de BSS.",
            {
              ttl: 3000,
              type: "warning",
            },
    ...
    $scope.getUsersByCompanyClientIdFn = function (data) {
      userServices.getUsersByCompanyClientId(data).then(function (response) {
        if (response.status == 200) {
          ...
          inform.add(
            "No se encontraron Administradores de Consorcios asociados a la administración, contacte al area de soporte de BSS.",
            {
              ttl: 3000,
              type: "warning",
            },
    ...
    $scope.sysTokenFn = function (vLength) {
      ...
      var randomString = "";
      for (i = 0; i < vLength; i++) {
        randomString += $scope.charters.charAt(
          Math.floor(Math.random() * $scope.charters.length),
        );
      }
      return randomString;
    };
    ...
    $scope.getKeyListByBuildingIdFn = function (idClient) {
      if (idClient != undefined) {
        KeysServices.getKeyListByBuildingId(idClient).then(
    ...
    $scope.checkDeliveryMethod = function (item) {
      if (
        ...
        ($scope.ticket.building != undefined &&
          ...
          $scope.ticket.building.isStockInBuilding == "0") ||
        ($scope.ticket.building != undefined &&
          $scope.ticket.building.allowOfficePickup != "1")
      ) {
        //console.log(item);
        $scope.ticket.delivery.idTypeDeliveryKf = "2";
    ...
    $scope.loadCustomerFieldsFn = function (obj) {
      ...
      $timeout(function () {
        $scope.mainSwitchFn(
          "loadBuildingData",
          $scope.select.buildings.selected,
          null,
        );
      }, 700);
    };
    $scope.excludeIdReasons = function (reason) {
      return (
        reason.idReasonDisabledItem !== "4" &&
        reason.idReasonDisabledItem !== "5"
      );
    };
      ...
      switch ($scope.ticket.optionTypeSelected.name) {
        ...
        case "building":
          switch ($scope.ticket.radioButtonBuilding) {
            case "1":
              return (
                item.idCategoryKf == "6" && item.idKeychainStatusKf != "-1"
              );
            case "2":
              return (
                item.idCategoryKf == "5" && item.idKeychainStatusKf != "-1"
              );
            case "3":
              return (
                item.idCategoryKf == "3" && item.idKeychainStatusKf != "-1"
              );
            case "4":
              return (
                item.idCategoryKf == "2" && item.idKeychainStatusKf != "-1"
              );
            case "5":
              return (
                item.idCategoryKf == "4" && item.idKeychainStatusKf != "-1"
              );
          }
          break;
      }
    ...
    $scope.mainSwitchFn = function (opt, obj, obj2) {
      switch (opt) {
        ...
        case "newKeyRequest":
          ...
          $scope.costs = {
            keys: { cost: formatDecimalLatam(0), manual: false },
            delivery: { cost: formatDecimalLatam(0), manual: false },
            service: { cost: formatDecimalLatam(0), manual: false },
            total: formatDecimalLatam(0),
          };
          ...
          if ($scope.sysLoggedUser.idProfileKf == 1) {
            ...
            $scope.sysLoggedUser.idProfileKf == 4 &&
            !$scope.isHomeSelected
          ) {
            $scope.isCompanyAdministrator = true;
            console.log($scope.sysLoggedUser);
            $scope.select.admins.selected = {
              idClient: $scope.sysLoggedUser.company[0].idClient,
              name: $scope.sysLoggedUser.company[0].name,
            };
        ...
        case "switchKeyCategory":
          ...
          if (
            ...
            $scope.ticket.radioButtonBuilding != "1" &&
            $scope.ticket.radioButtonBuilding != "4" &&
            $scope.ticket.radioButtonBuilding != "5"
          ) {
            $scope.getUsersByCompanyClientIdFn(obj.idClient);
          } else {
            if (
              $scope.ticket.radioButtonBuilding == "4" &&
              ((obj.isStockInBuilding == null && obj.isStockInOffice == null) ||
                (obj.isStockInBuilding == "0" && obj.isStockInOffice == "0") ||
                (obj.isStockInBuilding == null && obj.isStockInOffice == "0") ||
                (obj.isStockInBuilding == "0" && obj.isStockInOffice == null))
            ) {
              $scope.clientName = obj.name;
              $scope.msg1 = "El cliente ";
              $scope.msg2 =
                " No posee stock definido por lo que no puede generar Pedidos de Stock";
              $scope.msg3 =
                "Contacte con la administración y/o el area de soporte.";
              $("#customerNotificationModal").modal({
                backdrop: "static",
                keyboard: true,
              });
              ...
              if (
                $scope.ticket.radioButtonBuilding == "5" &&
                ((obj.isStockInBuilding == null &&
                  obj.isStockInOffice == null) ||
                  (obj.isStockInBuilding == "0" &&
                    obj.isStockInOffice == "0") ||
                  (obj.isStockInBuilding == null &&
                    obj.isStockInOffice == "0") ||
                  (obj.isStockInBuilding == "0" && obj.isStockInOffice == null))
              ) {
                ...
                $scope.msg1 = "El cliente ";
                $scope.msg2 =
                  " No posee stock definido por lo que no podra gestionar este pedido de manera convencional";
                $scope.msg3 =
                  "Verifique internamente con el Area de soporte BSS.";
                $("#customerNotificationModal").modal({
                  backdrop: "static",
                  keyboard: true,
                });
        ...
        case "changeDepartment":
          ...
          if ($scope.isRequest == "down") {
            KeysServices.getKeyListByDepartmentId(
              $scope.ticket.idClientDepartament.idClientDepartament,
            ).then(function (response_keys) {
              if (response_keys.status == 200) {
          ...
          if ($scope.ticket.idClientDepartament != undefined) {
            ...
            $scope.ticket_find.idDepartmentKf =
              $scope.ticket.idClientDepartament.idClientDepartament;
            $scope.ticket_find.idBuildingKf =
              $scope.ticket.idClientDepartament.idClient;
            ticketServices
              .ticketInitialDeliveryActiveByDeptoId($scope.ticket_find)
              .then(function (response) {
                console.log(response);
                if (response.status == 200) {
        ...
        case "loadBuildingData":
          ...
          console.log(
            "$scope.isCompanyAdministrator :" + $scope.isCompanyAdministrator,
          );
          ...
          if ($scope.sysLoggedUser.idProfileKf == "1" || obj.IsInDebt != "1") {
            ...
            if ($scope.isRequest != "costs") {
              blockUI.start(
                "Cargando datos asociados al consorcio " + obj.name,
              );
            }
            if (
              obj != undefined &&
              ...
              if ($scope.isRequest != "costs") {
                $scope.buildingDeliveryCost = NaN2Zero(
                  normalizeDecimal(obj.valor_envio),
                );
              }
              ...
              $timeout(function () {
                ...
                console.log(
                  "chargeForExpenses  :" +
                    $scope.ticket.building.chargeForExpenses,
                );
                if (
                  $scope.ticket.building.chargeForExpenses == "0" ||
                  $scope.ticket.building.chargeForExpenses == null ||
                  $scope.ticket.building.chargeForExpenses == undefined
                ) {
                  $scope.ticket.cost.idTypePaymentKf = 2;
              ...
              $timeout(function () {
                ...
                console.log(
                  "$scope.buildingServiceValue :" + $scope.buildingServiceValue,
                );
                console.log(
                  "$scope.buildingDeliveryCost :" + $scope.buildingDeliveryCost,
                );
                //$scope.mainSwitchFn('autoSelectDoors', null, null);
                blockUI.stop();
              }, 2000);
        ...
        case "myDepartments":
          ...
          $scope.statusByTenantType =
            $scope.sysLoggedUser.idTypeTenantKf == "1" ? -1 : -1;
          $scope.idDepartmentKfTmp =
            $scope.sysLoggedUser.idTypeTenantKf == "1"
              ? null
              : $scope.sysLoggedUser.idDepartmentKf;
          DepartmentsServices.listDepartmentsByIdOwner(
            $scope.idDepartmentKfTmp,
              ...
              if (response.data != undefined && response.data.length > 0) {
                ...
                angular.forEach(response.data, function (depto) {
                  ...
                  $timeout(function () {
                    ...
                    DepartmentsServices.listTenant2AssignedDeptoByIdDepto(
                      depto.idClientDepartament,
                    ).then(function (response_tenants) {
        ...
        case "selectedRequestKeyOwnerUser":
          //console.log(obj);
          $scope.selectedRequestKeyOwnerUser =
            obj != undefined ? obj : undefined;
          $scope.enabledNextBtn();
          inform.add(
            "El usuario " +
              obj.fullNameUser +
              " ha sido asignado como solicitante del pedido.",
            {
              ttl: 5000,
              type: "success",
            },
        ...
        case "setWhoPickUpList":
          ...
          if (
            ...
            if (
              ...
              $scope.selectedRequestKeyOwnerUser != null &&
              $scope.sysLoggedUser.idUser !=
                $scope.selectedRequestKeyOwnerUser.idUser
            ) {
          ...
          if (
            ...
            if (
              $scope.ticket.idClientDepartament != undefined &&
              $scope.ticket.idClientDepartament != null &&
              !$scope.ticket.departmentHasTicketsInitialDelivery &&
              $scope.ticket.building.isInitialDeliveryActive
            ) {
              if (!$scope.initialLoopExecuted) {
                $scope.initialLoopExecuted = true;
                var initialQtty = parseInt(
                  $scope.ticket.building.initial_delivery[0].initial_qtty,
                  10,
                );
                if (
                  $scope.ticket.radioButtonBuilding == "1" &&
                ...
                if (!isNaN(initialQtty)) {
                  for (let vQtty = 0; vQtty < initialQtty; vQtty++) {
                    console.log(
                      `Looping: vQtty=${vQtty}, initialQtty=${initialQtty}`,
                    );
                    $scope.mainSwitchFn(
                      "addKeyFieldsToList",
                      $scope.select.products.selected,
        ...
        case "selectedUser":
          ...
          inform.add(
            "El usuario " +
              obj.fullNameUser +
              " sera asociado al llavero seleccionado.",
            {
              ttl: 5000,
              type: "success",
            },
        ...
        case "addKeyFieldsToList":
          ...
          if (obj != undefined) {
            ...
            productSelected.idProductClassificationFk =
              obj.idProductClassificationFk;
          ...
          var userSelected =
            $scope.selectedUser != undefined ? $scope.selectedUser : null;
          var radioButtonDepartment =
            $scope.ticket.radioButtonDepartment != undefined
              ? $scope.ticket.radioButtonDepartment
              : null;
          var radioButtonBuilding =
            $scope.ticket.radioButtonBuilding != undefined
              ? $scope.ticket.radioButtonBuilding
              : null;
          for (var door in obj2) {
            if (obj2[door].selected == true) {
              $scope.list_doors_ticket.push({
                contractStatus: obj2[door].contractStatus,
                idAccessControlDoor: obj2[door].idAccessControlDoor,
                idContrato: obj2[door].idContrato,
                idService: obj2[door].controlAccessInternet.idService,
                idServiciosDelContratoCuerpo:
                  obj2[door].idServiciosDelContratoCuerpo,
                idStatusFk: obj2[door].idStatusFk,
                itemAclaracion: obj2[door].itemAclaracion,
                selected: obj2[door].selected,
                serviceName: obj2[door].serviceName,
                titulo: obj2[door].titulo,
              });
            }
          }
          console.log($scope.list_doors_ticket);
          var doorsSelected =
            $scope.list_doors_ticket.length > 0
              ? $scope.list_doors_ticket
              : null;
          ...
          switch (switchOption) {
            case "1":
              if (
                ...
                productSelected.isKeyTenantOnly =
                  $scope.ticket.userRequestBy.idTypeTenantKf != null &&
                  $scope.ticket.userRequestBy.idTypeTenantKf == "2"
                    ? 1
                    : null;
            ...
            case "2":
              if (
                ...
                productSelected.idClientKf =
                  $scope.select.buildings.selected.idClient;
                productSelected.idClientAdminKf =
                  $scope.select.admins.selected.idClient;
                productSelected.idDepartmenKf = null;
                productSelected.isKeyTenantOnly = null;
                $scope.keysAllowedTmp = $scope.keysAllowed;
              }
          ...
          if ($scope.list_keys.length == 0) {
            $scope.keysTotalPrice = 0;
            if (
              $scope.select.buildings.selected.initial_delivery != undefined &&
              $scope.select.buildings.selected.initial_delivery.length > 0
            ) {
              console.log(
                "$scope.select.buildings.selected.initial_delivery[0].initial_qtty  : " +
                  parseInt(
                    $scope.select.buildings.selected.initial_delivery[0]
                      .initial_qtty,
                  ),
              );
            }
            console.log(
              "$scope.list_keys.length                                            : " +
                parseInt($scope.list_keys.length + 1),
            );
            if (
              $scope.ticket.departmentHasTicketsInitialDelivery != undefined
            ) {
              console.log(
                "$scope.ticket.departmentHasTicketsInitialDelivery                  : " +
                  $scope.ticket.departmentHasTicketsInitialDelivery,
            ...
            if (
              ...
              productSelected.priceFabric = Number(
                $scope.select.buildings.selected.initial_delivery[0]
                  .initial_price,
              );
            } else if (
            ...
            $scope.list_keys.push({
              id: id,
              optionTypeSelected: $scope.ticket.optionTypeSelected.name,
              radioButtonDepartment: radioButtonDepartment,
              radioButtonBuilding: radioButtonBuilding,
              key: productSelected,
              user: userSelected,
              doors: doorsSelected,
            });
            ...
            if ($scope.list_keys.length < $scope.keysAllowedTmp) {
              for (var key in $scope.list_keys) {
                if (
                  $scope.list_keys[key].isLicenseDevice == null &&
                  $scope.list_keys[key].user != null &&
                  userSelected != null &&
                  $scope.list_keys[key].user.idUser ==
                    $scope.selectedUser.idUser
                ) {
                  inform.add(
                    "El Llavero seleccionado no ha sido agregado a la lista.",
                    {
                      ttl: 5000,
                      type: "warning",
                    },
                  ...
                  inform.add(
                    "El Usuario " +
                      $scope.selectedUser.fullNameUser +
                      ", ya se encuentra asociado a un llavero de la lista.",
                    {
                      ttl: 5000,
                      type: "warning",
                    },
                ...
                if (productSelected.isLicenseDevice == null) {
                  if ($scope.list_keys[key].key.isLicenseDevice != null) {
                    inform.add(
                      "Solo puedes solicitar Llaveros o Licencias pero no es posible combinar en el mismo pedido.",
                      {
                        ttl: 5000,
                        type: "warning",
                      },
              ...
              if (!$scope.isUserExist) {
                ...
                if (
                  !$scope.ticket.departmentHasTicketsInitialDelivery &&
                  $scope.select.buildings.selected.initial_delivery.length >
                    0 &&
                  !$scope.select.buildings.selected.initial_delivery[0]
                    .expiration_state &&
                  $scope.list_keys.length + 1 <=
              ...
              inform.add(
                "Puede solicitar hasta un maximo de " +
                  $scope.keysAllowedTmp +
                  ", si desea hacer un pedido mayor, contactar con el equipo de BSS Seguridad.",
                {
                  ttl: 5000,
                  type: "warning",
                },
              ...
              if (userSelected == null) {
                inform.add(
                  "El llavero " +
                    ...
                    $scope.ticket.idClientDepartament.Depto +
                    " ha sido agregado al pedido.",
                  {
                    ttl: 5000,
                    type: "success",
                  },
              ...
              if ($scope.ticket.radioButtonBuilding == "1") {
                if (userSelected == null) {
                  inform.add(
                    "El llavero " +
                      productSelected.descriptionProduct +
                      " asociado al Personal del Edificio:  " +
                      $scope.select.buildings.selected.name +
                      " ha sido agregado al pedido.",
                    {
                      ttl: 5000,
                      type: "success",
                ...
                inform.add(
                  "El llavero " +
                    productSelected.descriptionProduct +
                    " asociado a la Administracion:  " +
                    $scope.select.admins.selected.name +
                    " ha sido agregado al pedido.",
                  {
                    ttl: 5000,
                    type: "success",
        ...
        case "setKeysToList":
          ...
          switch (switchOption) {
            case "1":
              if (
                $scope.ticket.optionTypeSelected == "department" &&
                $scope.ticket.radioButtonDepartment != undefined
              ) {
                productSelected.idCategoryKf = 1;
                productSelected.categoryName = "Departamento";
        ...
        case "addKeyToDownList":
          ...
          if ($scope.list_keys.length == 0 && obj.selected == true) {
            ...
            for (var key in $scope.list_keys) {
              if (
                $scope.list_keys[key].key.idKeychain == obj.idKeychain &&
                obj.selected
              ) {
                ...
                $scope.list_keys[key].key.idKeychain == obj.idKeychain &&
                (!obj.selected || !$scope.list_keys[key].selected)
              ) {
                $scope.isKeyExist = true;
        ...
        case "deleteKeyFieldsToList":
          if ($scope.ticket.optionTypeSelected.name == "department") {
            if (obj.user == null) {
              inform.add(
                "El llavero " +
                  obj.key.descriptionProduct +
                  " asociado al Departamento:  " +
                  $scope.ticket.idClientDepartament.Depto +
                  " ha sido removido al pedido.",
                {
                  ttl: 5000,
                  type: "warning",
                },
        ...
        case "addTenant":
          ...
          $scope.register.user.idProfileKf =
            $scope.isNewTenant &&
            obj.idTypeTenantKf != undefined &&
            obj.idTypeTenantKf == 1
              ? 3
              : 5;
          ...
          $scope.register.user.idTyepeAttendantKf =
            obj.idProfileKf == 6 ? obj.idTyepeAttendantKf : null;
          $scope.register.user.dni = obj.dni;
          $scope.register.user.isCreateByAdmin =
            $scope.sysLoggedUser.idProfileKf == 4 ? 1 : null;
          $scope.register.user.idAddresKf =
            ($scope.register.user.idProfileKf == 4 ||
              $scope.register.user.idProfileKf == 5) &&
            ($scope.register.user.idTypeTenantKf != null ||
              $scope.register.user.idTypeTenantKf != 0)
              ? obj.idAddresKf
              : null;
          $scope.register.user.idTypeTenantKf = obj.idTypeTenantKf;
          $scope.register.user.idDepartmentKf =
            (obj.idProfileKf == 5 || obj.idProfileKf == 6) &&
            obj.idTypeTenantKf == 2
              ? obj.idDepartmentKf
              : null;
          $scope.register.user.idDeparment_Tmp =
            (obj.idProfileKf == 3 || obj.idProfileKf == 6) &&
            obj.idTypeTenantKf == 1
              ? obj.idDepartmentKf
              : null;
        ...
        case "edit":
          ...
          if (obj.idProfileKf == "3" || obj.idProfileKf == "5") {
            ...
            $scope.tenant.update.phonelocalNumberUser =
              obj.phoneLocalNumberUser;
            ...
            $scope.tenant.update.idAddresKf =
              $scope.select.buildings.selected.idClient;
            ...
            obj.idProfileKf == "4" ||
            (obj.idProfileKf == "6" &&
              (obj.idTypeTenantKf >= 1 || obj.idTypeTenantKf == null))
          ) {
            ...
            $scope.attendant.update.phonelocalNumberUser =
              obj.phoneLocalNumberUser;
            ...
            $scope.attendant.update.idAddresKf =
              $scope.select.buildings.selected.idClient;
            ...
            $scope.attendant.update.building =
              $scope.select.buildings.selected.address;
            $scope.attendant.update.idTypeAttKf = {
              idTyepeAttendant: obj.idTyepeAttendantKf,
              nameTypeAttendant: obj.nameTypeAttendant,
            };
            if (
              obj.idTyepeAttendantKf != null &&
              obj.idTyepeAttendantKf != 1 &&
              obj.idTypeTenantKf == 1
            ) {
              //console.log(obj);
              $scope.att.ownerOption = "1";
        ...
        case "update":
          ...
          if (obj.idProfileKf == "3" || obj.idProfileKf == "5") {
            ...
            $timeout(function () {
              ...
              $scope.update.user.idDeparment_Tmp =
                ...
                $scope.update.user.idTypeTenantKf == 1
                  ...
                  : null;
              if (
                $scope.update.user.idTypeTenantKf_tmp !=
                $scope.update.user.idTypeTenantKf
              ) {
                $scope.remove.info.idUser = $scope.update.user.idUser;
                $scope.remove.info.idDepartmentKf =
                  $scope.update.user.idTypeTenantKf == 1
                    ? $scope.update.user.idDeparment_Tmp
                    : $scope.update.user.idDepartmentKf;
                $scope.remove.info.idTypeTenant =
                  $scope.update.user.idTypeTenantKf_tmp;
            ...
            $scope.update.user = obj;
            $scope.update.user.idTyepeAttendantKf =
              obj.idTypeAttKf.idTyepeAttendant;
            $scope.update.user.idTypeTenantKf =
              $scope.att.ownerOption == undefined ||
              $scope.att.ownerOption == null ||
              $scope.att.ownerOption == 3 ||
              obj.idTypeAttKf.idTyepeAttendant == 1
                ? null
                : $scope.att.ownerOption;
            $scope.update.user.fullNameUser = obj.fullname;
            $scope.update.user.emailUser = obj.email;
            $scope.update.user.phoneLocalNumberUser = obj.phonelocalNumberUser;
            $scope.update.user.phoneNumberUser = obj.phoneMovilNumberUser;
            $scope.update.user.idAddresKf =
              (obj.idProfileKf == 6 && $scope.att.ownerOption != null) ||
              $scope.att.ownerOption != 0
                ? obj.idAddresKf
                : null;
            $scope.update.user.idDepartmentKf =
            ...
            $scope.update.user.idDeparment_Tmp =
              ...
              obj.idTypeAttKf.idTyepeAttendant != 1
                ...
                : null;
            $scope.update.user.idDepartmentKf =
              $scope.sysSubContent == "attendants" &&
            ...
            $scope.update.user.idDeparment_Tmp =
              $scope.sysSubContent == "attendants" &&
              $scope.update.user.idDeparment_Tmp == null &&
              $scope.update.user.idTypeTenantKf == 1 &&
              $scope.att.ownerOption != 3
                ? obj.idDepartmentKf2
                : $scope.update.user.idDeparment_Tmp;
            $scope.update.user.isEdit = 1;
            $scope.update.user.descOther =
              obj.idTypeAttKf.idTyepeAttendant == 1 ? obj.typeOtherAtt : null;
            $scope.update.user.requireAuthentication =
              obj.idTypeAttKf.idTyepeAttendant == 1 ? 0 : 1;
        ...
        case "newAttendant":
          ...
          $scope.att = { ownerOption: undefined };
          $scope.att.ownerOption =
            $scope.sysContent == "attendants" ? 3 : undefined;
          ...
          $scope.attendant.new.idAddresKf =
            $scope.select.buildings.selected.idClient;
          $scope.attendant.new.building =
            $scope.select.buildings.selected.address;
          //$scope.closeMembersTypeModal();
          $("#RegisterAttendant").modal({
            backdrop: "static",
            keyboard: false,
          });
        ...
        case "addAttendant":
          ...
          $scope.register.user.phoneLocalNumberUser = obj.phonelocalNumberUser;
          $scope.register.user.idTyepeAttendantKf =
            obj.idProfileKf == 6 ? obj.idTypeAttKf.idTyepeAttendant : null;
          $scope.register.user.dni = obj.dni;
          $scope.register.user.idTypeTenantKf =
            $scope.att.ownerOption == undefined ||
            $scope.att.ownerOption == null ||
          ...
          $scope.register.user.idDeparment_Tmp =
            ...
            obj.idTypeAttKf.idTyepeAttendant != 1
              ? obj.idDepartmentKf
              : null;
          $scope.register.user.requireAuthentication =
            obj.idTypeAttKf.idTyepeAttendant == 1 ? 0 : 1;
          $scope.register.user.descOther =
            obj.idTypeAttKf.idTyepeAttendant == 1 ? obj.typeOtherAtt : null;
          console.log($scope.register.user);
          $scope.sysRegisterTenantFn();
          break;
        ...
        case "setCosts":
          console.log($scope.ticket);
          console.log(
            typeof $scope.ticket.radioButtonDepartment,
            $scope.ticket.radioButtonDepartment,
          );
          console.log($scope.costs);
          console.log($scope.ticket.cost);
          if (
            ...
            if (
              ...
              if (!$scope.costs.keys.manual) {
                ...
                for (var key in $scope.list_keys) {
                  var keyCost =
                    $scope.list_keys[key].key.priceFabric != undefined
                      ? $scope.list_keys[key].key.priceFabric
                      : 0;
                  if (subTotalKeys == 0) {
                    subTotalKeys = NaN2Zero(normalizeDecimal(keyCost));
                  } else {
                    subTotalKeys =
                      NaN2Zero(normalizeDecimal(subTotalKeys)) +
                      NaN2Zero(normalizeDecimal(keyCost));
                  }
                }
                $scope.ticket.cost.keys = formatDecimalLatam(subTotalKeys);
                $scope.costs.keys.cost = formatDecimalLatam(subTotalKeys);
              } else {
                subTotalKeys = NaN2Zero(
                  normalizeDecimal($scope.costs.keys.cost),
                );
                subTotalKeys = NaN2Zero(
                  normalizeDecimal($scope.ticket.cost.keys),
                );
              }
              //DELIVERY COSTS
              //$scope.isRequest
              ...
              if (!$scope.costs.delivery.manual) {
                if ($scope.deliveryCostFree == 0) {
                  if (
                    ...
                    if (
                      ...
                      if (
                        $scope.ticket.delivery.whoPickUp != undefined &&
                        $scope.ticket.delivery.whoPickUp != null &&
                        ...
                        if ($scope.ticket.cost.service > 0) {
                          ...
                          $scope.ticket.cost.delivery = formatDecimalLatam(
                        ...
                        $scope.costs.delivery.cost =
                          formatDecimalLatam(subTotalDelivery);
                      } else {
                        if (
                          ($scope.ticket.delivery.whoPickUp != undefined &&
                            $scope.ticket.delivery.whoPickUp != null &&
                          ...
                          ($scope.ticket.delivery.idDeliveryTo != null &&
                            $scope.ticket.delivery.idDeliveryTo == 1 &&
                            $scope.ticket.delivery.whoPickUp.idUser !=
                              undefined)
                        ) {
                          console.log("1");
                          console.log($scope.ticket);
                          if ($scope.ticket.cost.service > 0) {
                            ...
                            $scope.ticket.cost.delivery =
                              $scope.ticket.delivery.zone != null &&
                              $scope.ticket.delivery.zone != undefined
                                ? formatDecimalLatam(
                            ...
                            subTotalDelivery = NaN2Zero(
                              normalizeDecimal($scope.ticket.cost.delivery),
                            );
                          }
                        } else {
                          console.log("2");
                ...
                subTotalDelivery = NaN2Zero(
                  normalizeDecimal($scope.costs.delivery.cost),
                );
                subTotalDelivery = NaN2Zero(
                  normalizeDecimal($scope.ticket.cost.delivery),
                );
              ...
              if ($scope.serviceCostFree == 0) {
                if (!$scope.costs.service.manual) {
                  ...
                  console.log(
                    "$scope.ticket.cost.service: " +
                      $scope.buildingServiceValue,
                  );
                  var subTotalService = 0;
                  subTotalService = NaN2Zero(
                    normalizeDecimal($scope.buildingServiceValue),
                  );
                  $scope.costs.service.cost =
                    formatDecimalLatam(subTotalService);
                } else {
                  subTotalService = NaN2Zero(
                    normalizeDecimal($scope.costs.service.cost),
                  );
                  subTotalService = NaN2Zero(
                    normalizeDecimal($scope.ticket.cost.service),
                  );
                }
              } else {
          ...
          $scope.ticket.cost.total = 0;
          console.log(
            "subTotalService    : " + formatDecimalLatam(subTotalService),
          );
          console.log(
            "subTotalKeys       : " + formatDecimalLatam(subTotalKeys),
          );
          console.log(
            "subTotalDelivery   : " + formatDecimalLatam(subTotalDelivery),
          );
        ...
        case "recalculateCosts":
          if (
            ...
            var subTotalKeys = NaN2Zero(
              normalizeDecimal($scope.ticket.cost.keys),
            );
            var subTotalService = NaN2Zero(
              normalizeDecimal($scope.ticket.cost.service),
            );
            var subTotalDelivery = NaN2Zero(
              normalizeDecimal($scope.ticket.cost.delivery),
            );
            var subTotalCosts = 0;
            console.log(
            ...
            switch (opt2) {
              case "service":
                if (
                  Number(subTotalService) != NaN2Zero(normalizeDecimal(obj))
                ) {
              ...
              case "delivery":
                if (
                  Number(subTotalDelivery) != NaN2Zero(normalizeDecimal(obj))
                ) {
        ...
        case "sendNotification":
          switch (obj) {
            ...
            case "1":
              if (
                $scope.costs.keys.cost == 0 &&
                $scope.costs.delivery.cost == 0 &&
                $scope.costs.service.cost == 0
              ) {
                $scope.costs.keys.cost = formatDecimalLatam(
                  $scope.ticket.cost.keys,
                );
                $scope.costs.delivery.cost = formatDecimalLatam(
                  $scope.ticket.cost.delivery,
                );
                $scope.costs.service.cost = formatDecimalLatam(
                  $scope.ticket.cost.service,
                );
              }
              $scope.mainSwitchFn("setCosts", null, null);
        ...
        case "up": // SOLOCITUD DE ALTA
          ...
          $scope.new.ticket.isInitialDeliveryActive = obj.building
          ...
          $scope.new.ticket.mail =
            '<table width="100%" style="max-width: 768px;min-width: 100%;border-collapse: collapse; padding-top:2%; padding-bottom:2%;font-size:1vw;font-family:sans-serif;color:#555555;padding:2%">';
          $scope.new.ticket.mail +=
            '<tbody><tr><td align="center" valign="middle" colspan="4" style="background:#427a9d;color:white; padding:0.4%">Datos de la Solicitud</td></tr>';
          $scope.new.ticket.mail +=
            '<tr><td align="center" valign="middle"style="width: 15%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Realizado por</td>';
          $scope.new.ticket.mail +=
            '<td align="left" valign="middle" style="width: 35%;font-size: 1vw;padding-left: 0.4%">' +
            $scope.sysLoggedUser.fullNameUser +
            ' <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
            $scope.sysLoggedUser.nameProfile +
            "</b></span></td>";
          $scope.new.ticket.mail +=
            '<td align="center" valign="middle" style="width: 15%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Solicitado por</td>';
          if (
            obj.optionTypeSelected.name == "department" &&
            obj.radioButtonDepartment != undefined &&
            (obj.radioButtonDepartment == "1" ||
              obj.radioButtonDepartment == "2")
          ) {
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle">' +
              $scope.selectedRequestKeyOwnerUser.fullNameUser +
              ' <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
              $scope.selectedRequestKeyOwnerUser.nameProfile +
              "</b></span>";
            if (
              $scope.selectedRequestKeyOwnerUser.idProfileKf != 3 &&
              $scope.selectedRequestKeyOwnerUser.idProfileKf != 5 &&
              $scope.selectedRequestKeyOwnerUser.idTypeTenantKf != null
            ) {
              $scope.new.ticket.mail +=
                ' <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
                $scope.selectedRequestKeyOwnerUser.typeTenantName +
                "</b></span>";
            }
            $scope.new.ticket.mail += "</td>";
          } else if (
            obj.optionTypeSelected.name == "building" &&
            obj.radioButtonBuilding != undefined &&
            (obj.radioButtonBuilding == "1" || obj.radioButtonBuilding == "2")
          ) {
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle" style="width: 40%;font-size: 1vw;padding-left: 0.4%">' +
              obj.administration.name +
              ' <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
              obj.administration.ClientType +
              "</b></span></td>";
          } else if (
            obj.optionTypeSelected.name == "building" &&
            obj.radioButtonBuilding != undefined &&
            obj.radioButtonBuilding != "1" &&
            obj.radioButtonBuilding != "2"
          ) {
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle" style="width: 40%;font-size: 1vw;padding-left: 0.4%">' +
              $scope.sysLoggedUser.fullNameUser +
          ...
          $scope.new.ticket.mail +=
            '</tr><tr><td  align="center" valign="middle"style="width: 15%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Fecha de solicitud</td>';
          ...
          $scope.new.ticket.mail +=
            '<td align="left" valign="middle">' + formatedDate + "</td>";
          $scope.new.ticket.mail +=
            '<td align="center" valign="middle" style="width: 15%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Solicitado para</td>';
          if (
            obj.optionTypeSelected.name == "department" &&
            obj.radioButtonDepartment != undefined &&
            (obj.radioButtonDepartment == "1" ||
            ...
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle">Departamento <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
              obj.idClientDepartament.Depto +
              "</b></span></td>";
          } else if (
            obj.optionTypeSelected.name == "building" &&
            obj.radioButtonBuilding != undefined &&
            ...
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle">Encargado</td>';
          } else if (
            obj.optionTypeSelected.name == "building" &&
            obj.radioButtonBuilding != undefined &&
            obj.radioButtonBuilding == "2"
            ...
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle">Administración</td>';
          } else if (
            obj.optionTypeSelected.name == "building" &&
            obj.radioButtonBuilding != undefined &&
            obj.radioButtonBuilding != "1" &&
            ...
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle">Personal del Edificio</td>';
          }
          $scope.new.ticket.mail += "</tr></tbody>";
          $scope.new.ticket.mail +=
            '<tbody><tr><td align="center" valign="middle" colspan="4" style="background:#427a9d;color:white; padding:0.4%">Detalles - Dirección</td></tr>';
          $scope.new.ticket.mail +=
            '<tr><td align="center" valign="middle" style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Administracíon</td>';
          $scope.new.ticket.mail +=
            '<td align="left" valign="middle">' +
            obj.administration.name +
            "</td>";
          $scope.new.ticket.mail +=
            '<td align="center" valign="middle" style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Personal del Edificio</td>';
          $scope.new.ticket.mail +=
            '<td align="left" valign="middle">' + obj.building.name + "</td>";
          $scope.new.ticket.mail += "</tr></tbody>";
          /*-- KEYS REQUESTED --*/
          $scope.new.ticket.mail +=
            '<tbody><tr><td align="center" valign="middle" colspan="4" style="background:#427a9d;color:white; padding:0.4%">Llaves solicitadas</td></tr>';
          $scope.new.ticket.mail +=
            '<tr><td colspan="4" style="background:#fff;">';

          $scope.new.ticket.mail +=
            '<table width="100%" style="max-width:768px;min-width:100%;background-color: #fff;">';
          $scope.new.ticket.mail += "<thead><tr>";
          $scope.new.ticket.mail +=
            '<th width="5px"  style="background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> N°</th>';
          $scope.new.ticket.mail +=
            '<th style="background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> Llavero</th>';
          $scope.new.ticket.mail +=
            '<th style="background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> Precio</th>';
          ...
          if (
            ...
            $scope.new.ticket.mail +=
              '<th style="background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> Asignado</th>';
          }
          if (obj.optionTypeSelected.name == "building") {
            $scope.new.ticket.mail +=
              '<th style="background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> Categoria</th>';
          }
          /*<th style="background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> Usuario </th>*/
          $scope.new.ticket.mail +=
            '<th style="background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> Puertas</th>';
          $scope.new.ticket.mail += "</tr></thead>";
          '<tbody style="overflow: auto;">';
          $scope.new.ticket.mail += '<tbody style="overflow: auto;">';
          for (var i = 0; i < $scope.list_keys.length; i++) {
            var idUserKf =
              $scope.list_keys[i].user != undefined
                ? $scope.list_keys[i].user.idUser
                : null;
            $scope.new.ticket.keys.push({
              idProductKf: $scope.list_keys[i].key.idProduct,
              idCategoryKf: $scope.list_keys[i].key.idCategoryKf,
              idUserKf: idUserKf,
              idDepartmenKf: $scope.list_keys[i].key.idDepartmenKf,
              isKeyTenantOnly: $scope.list_keys[i].key.isKeyTenantOnly,
              idClientKf: $scope.list_keys[i].key.idClientKf,
              priceFabric: $scope.list_keys[i].key.priceFabric,
              doors: $scope.list_keys[i].doors,
            });
            $scope.new.ticket.mail +=
              '<tr style="align-content: center; cursor: pointer;">';
            $scope.new.ticket.mail +=
              '<td style="vertical-align: middle;text-align: center;"><span class="font-size-18px">' +
              (i + 1) +
              "</span></td>";
            $scope.new.ticket.mail +=
              '<td style="vertical-align: middle;text-align: center;">' +
              $scope.list_keys[i].key.descriptionProduct +
              ' <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
              $scope.list_keys[i].key.brand +
              "</b></span></td>";
            $scope.new.ticket.mail +=
              '<td style="vertical-align: middle;text-align: right;">$ ' +
              $scope.list_keys[i].key.priceFabric +
              "</td>";
            if (obj.optionTypeSelected.name == "building") {
              $scope.new.ticket.mail +=
                '<td style="vertical-align: middle;text-align: center;"><span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
                $scope.list_keys[i].key.categoryName +
                "</b></span></td>";
            }
            ...
            if (
              ...
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
                $scope.list_keys[i].user.nameProfile +
                "</b></span>";
            }
            if (
              obj.optionTypeSelected.name == "building" &&
              ...
              obj.radioButtonBuilding != "1" &&
              obj.radioButtonBuilding != "2" &&
              $scope.list_keys[i].key.idCategoryKf != "5" &&
              $scope.list_keys[i].key.idCategoryKf != "6"
            ) {
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>Personal del Edificio</b></span>';
            }
            if (
              obj.optionTypeSelected.name == "building" &&
              obj.radioButtonBuilding == "2" &&
              ...
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>Administracíon</b></span>';
            }
            if (
              obj.optionTypeSelected.name == "department" &&
              (obj.radioButtonDepartment == null ||
                obj.radioButtonDepartment == "1" ||
                obj.radioButtonDepartment == "2")
            ) {
              $scope.new.ticket.mail +=
            ...
            $scope.new.ticket.mail +=
              '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
              $scope.list_keys[i].doors.length +
              "</b></span>";
            $scope.new.ticket.mail += "</td>";
          ...
          /*-- DELIVERY METHOD --*/
          $scope.new.ticket.mail +=
            '<tbody><tr><td align="center" valign="middle" colspan="4" style="background:#427a9d;color:white; padding:0.4%">Detalles del Envío</td></tr>';
          $scope.new.ticket.mail +=
            '<tr><td align="center" valign="middle" style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff; padding-left: 0.4%">Método</td>';
          if (obj.delivery.idTypeDeliveryKf == "1") {
            $scope.new.ticket.mail +=
              '<td align="left" style="width: 40%;" valign="middle">Retiro en Oficina</td>';
          } else if (obj.delivery.idTypeDeliveryKf == "2") {
            $scope.new.ticket.mail +=
              '<td align="left" style="width: 40%;" valign="middle">Entrega en Domicilio ';
            if (
              ...
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>Asociado</b></span>';
            } else if (
              (obj.optionTypeSelected.name == "building" ||
                obj.optionTypeSelected.name == "department") &&
              obj.radioButtonBuilding == 1 &&
              obj.delivery.idTypeDeliveryKf == 2 &&
              (obj.delivery.idDeliveryTo == 1 || obj.delivery.whoPickUp.id == 2)
            ) {
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
                obj.building.name +
              ...
              (obj.optionTypeSelected.name == "building" ||
                obj.optionTypeSelected.name == "department") &&
              (obj.radioButtonBuilding == 2 || obj.radioButtonBuilding == 3) &&
              obj.delivery.idTypeDeliveryKf == 2 &&
              (obj.delivery.idDeliveryTo == 1 || obj.delivery.whoPickUp.id == 2)
            ) {
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
                obj.administration.address +
                "</b></span>";
            } else if (
              obj.optionTypeSelected.name == "department" &&
              obj.delivery.idTypeDeliveryKf == 2 &&
              ...
              (obj.delivery.whoPickUp.id == undefined ||
                obj.delivery.whoPickUp.id == 1)
            ) {
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>Otro</b></span>';
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;text-transform: uppercase;"><b>' +
                obj.delivery.otherAddress.streetName +
                " " +
                obj.delivery.otherAddress.streetNumber +
                "</b></span>";
            } else if (
              obj.delivery.idTypeDeliveryKf == 2 &&
              ...
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;text-transform: uppercase;"><b>' +
                obj.delivery.thirdPerson.streetName +
                " " +
                obj.delivery.thirdPerson.streetNumber +
                "</b></span>";
            }
            $scope.new.ticket.mail += "</td>";
          }
          if (obj.delivery.idTypeDeliveryKf == null) {
            $scope.new.ticket.mail +=
              '<td align="left" style="width: 40%;" valign="middle">Proceso interno</td>';
          }
          if (obj.delivery.idTypeDeliveryKf != null) {
            if (obj.delivery.idTypeDeliveryKf == "1") {
              $scope.new.ticket.mail +=
                '<td align="center" valign="middle" style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff; padding-left: 0.4%">Quien retira</td>';
            } else if (obj.delivery.idTypeDeliveryKf == "2") {
              $scope.new.ticket.mail +=
                '<td align="center" valign="middle" style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff; padding-left: 0.4%">Quien recibe</td>';
            }
            if (obj.delivery.idTypeDeliveryKf != null) {
              $scope.new.ticket.mail +=
                '<td align="left" style="width: 40%;" valign="middle">' +
                obj.delivery.deliveryTo.fullNameUser;
            }
            if (
              obj.delivery.whoPickUp != null &&
              obj.delivery.whoPickUp.id != 3 &&
              (obj.delivery.whoPickUp.id == undefined ||
                obj.delivery.whoPickUp.id == 2)
            ) {
              $scope.new.ticket.mail +=
                ' <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
                obj.delivery.deliveryTo.nameProfile +
                "</b></span>";
            } else if (
              obj.delivery.whoPickUp != null &&
              obj.delivery.whoPickUp.id == 3
              ...
              $scope.new.ticket.mail +=
                ' <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>Tercera Persona</b></span>';
            } else if (
              obj.delivery.deliveryTo == null &&
              obj.delivery.deliveryTo.idProfileKf != 3 &&
              obj.delivery.deliveryTo.idProfileKf != 5 &&
              obj.delivery.deliveryTo.idTypeTenantKf != null
            ) {
              $scope.new.ticket.mail +=
                '<span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
                obj.delivery.deliveryTo.typeTenantName +
                "</b></span>";
            }
            $scope.new.ticket.mail += "</td>";
          }
          if (obj.delivery.idTypeDeliveryKf == null) {
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle" style="width: 10%; background-color: #b8c3d2;font-size: 1vw !important;color: #fff; padding-left: 0.4%">Procesado por</td>';
            $scope.new.ticket.mail +=
              '<td align="left" style="width: 40%;" valign="middle"><span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>BSS</b></span></td>';
          }
          if (obj.delivery.idTypeDeliveryKf == "1") {
            $scope.new.ticket.mail += "</tr><tr>";
            $scope.new.ticket.mail +=
              '<td align="center" valign="middle" colspan="4" style="background-color: #d9edf7;font-size: 1.2vw !important;color: #31708f;border-left: 1px solid transparent !important;border-right: 1px solid transparent !important;border-top: 1px solid transparent !important;border-radius: 40px 40px 0px 0px;border-color: #bce8f1;"><strong>INFORMACION IMPORTANTE</strong></td>';
            $scope.new.ticket.mail += "</tr><tr>";
            $scope.new.ticket.mail +=
            ...
            $scope.new.ticket.mail +=
              '<li style="text-align:justify;padding-right: 15px;">una vez autorizado el pedido por parte de la administración y cuando se encuentre preparado, el solicitante recibirá un correo confirmado que el pedido esta listo para retirar por nuestras oficinas.</li>';
            $scope.new.ticket.mail +=
              '<li style="list-style:none;text-align: justify;"><br>Podrá verificar el estado en todo momento desde la pantalla MONITOR DE PEDIDOS</li>';
          ...
          if (obj.delivery.idTypeDeliveryKf == "2") {
            ...
            $scope.new.ticket.mail +=
              '<td align="center" valign="middle" colspan="4" style="background-color: #d9edf7;color: #31708f;border-bottom: 1px solid transparent !important;border-left: 1px solid transparent !important;border-right: 1px solid transparent !important;border-top: 0px;border-radius: 0px 0px 40px 40px;border-color: #bce8f1;"><ul style="padding-right: 15px;font-size: 0.9vw !important;">';
            $scope.new.ticket.mail +=
              '<li style="text-align:justify;padding-right: 15px;">todos los pedidos autorizados y pagados antes de los dias lunes a las 12 hs serán etregados por la empresa de logística los dias martes de 16 a 22 hs (con un segundo intento de entrega los dias miércoles)</li>';
            $scope.new.ticket.mail +=
              '<li style="text-align:justify;padding-right: 15px;">todos los pedidos autorizados y pagados antes de los dias jueves a las 12 hs serán repartidos por la empresa de logística los dias viernes de 16 a 22 hs (con un segundo intento de entrega los dias lunes)</li>';
            $scope.new.ticket.mail +=
              '<li style="list-style:none;text-align: justify;"><br>En ambos casos el solicitante recibirá un correo confirmando que el pedido se encuentra en la lista de entrega.</li>';
            $scope.new.ticket.mail +=
              '<li style="list-style:none;text-align: justify;"><br>Podrá verificar el estado en todo momento desde la pantalla MONITOR DE PEDIDOS</li>';
            $scope.new.ticket.mail += "</ul></td>";
          }
          ...
          /*--  PAYMENT METHOD --*/
          $scope.new.ticket.mail +=
            '<tbody><tr><td align="center" valign="middle" colspan="10" style="background:#427a9d;color:white; padding:0.4%">Metodo de Pago</td></tr>';
          $scope.new.ticket.mail +=
            '<tr><td align="center" valign="middle" style="vertical-align: middle;width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff; padding-left: 0.4%">Método</td>';
          if (obj.cost.idTypePaymentKf == null) {
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle" style="width: 90%;" colspan="7" ><img data-type="image" itemprop="image" style="width: 10%;max-width: 110% !important;" src="' +
              serverHost +
              '"/images/logo_2.png"></td>';
          }
          if (
            obj.cost.idTypePaymentKf == "1" &&
            obj.optionTypeSelected.name == "department"
          ) {
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle" style="width: 90%;" align="center" valign="middle"colspan="7" >Abono por expensas</td>';
          }
          if (
            obj.cost.idTypePaymentKf == "1" &&
            (obj.radioButtonBuilding == "1" ||
              obj.radioButtonBuilding == "2" ||
              obj.radioButtonBuilding == "3")
          ) {
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle" style="width: 90%;" colspan="7" >Pago en Abono</td>';
          }
          if (obj.cost.idTypePaymentKf == "2") {
            $scope.new.ticket.mail +=
              '<td align="left" valign="middle" style="width: 90%;" colspan="7"><img data-type="image" itemprop="image" src="' +
              serverHost +
              '/images/mp_logo.png" style="width: 10%;max-width: 110% !important;"></td>';
          }
          /*--  PAYMENT METHOD --*/
          $scope.new.ticket.mail += "</tr></tbody>";
          /*--  COSTS --*/
          $scope.new.ticket.mail +=
            '<tbody><tr><td align="center" valign="middle" colspan="10" style="background:#427a9d;color:white; padding:0.4%">Detalles de Costos</td></tr>';
          $scope.new.ticket.mail +=
            '<tr><td colspan="10" style="background:#fff;">';
          $scope.new.ticket.mail += '<table width="100%">';
          $scope.new.ticket.mail += '<tbody style="text-align: right;"><tr>';
          $scope.new.ticket.mail +=
            '<td style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;text-align: center;">Gestión</td>';
          $scope.new.ticket.mail +=
            '<td style="width: 15%;"> $ ' + obj.cost.service + "</td>";
          $scope.new.ticket.mail +=
            '<td style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;text-align: center;">Llaves</td>';
          $scope.new.ticket.mail +=
            '<td style="width: 15%;"> $ ' + obj.cost.keys + "</td>";
          $scope.new.ticket.mail +=
            '<td style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;text-align: center;">Envío</td>';
          $scope.new.ticket.mail +=
            '<td style="width: 15%;"> $ ' + obj.cost.delivery + "</td>";
          $scope.new.ticket.mail +=
            '<td style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;text-align: center;">Total</td>';
          $scope.new.ticket.mail +=
            '<td style="width: 15%;"> $ ' + obj.cost.total + "</td>";
          $scope.new.ticket.mail += "</tr></tbody></table>";
          $scope.new.ticket.mail += "</td>";
          /*--  COSTS --*/
          $scope.new.ticket.mail += "</tr></tbody>";
          $scope.new.ticket.mail +=
            '<tbody><tr><td align="center" valign="middle" colspan="10" style="background:#427a9d;color:white; padding:1.5%"></td></tr></tbody>';
              ...
              switch (obj.radioButtonDepartment) {
                case "1":
                  if ($scope.sysLoggedUser.idProfileKf == "3") {
                    ...
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                      $scope.sysLoggedUser.idUser;
                    $scope.new.ticket.idUserRequestByProfile =
                      $scope.sysLoggedUser.idProfileKf;
                    $scope.new.ticket.idUserRequestByTypeTenant =
                      $scope.sysLoggedUser.idTypeTenantKf;
                    ...
                    console.log(
                      "[New Ticket] => BSS haciendo pedido a Propietario.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                      obj.userRequestBy.idUser;
                    $scope.new.ticket.idUserRequestByProfile =
                      obj.userRequestBy.idProfileKf;
                    $scope.new.ticket.idUserRequestByTypeTenant =
                    ...
                    ($scope.sysLoggedUser.idTypeTenantKf == null ||
                      $scope.sysLoggedUser.idTypeTenantKf != null) &&
                    (!$scope.isHomeSelected || $scope.isHomeSelected)
                  ) {
                    console.log(
                      "[New Ticket] => Admin consorcio haciendo pedido a Propietario.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                    ...
                    console.log(
                      "[New Ticket] => Admin consorcio haciendo pedido a otro Admin de consorcio de tipo Propietario.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                    ...
                    console.log(
                      "[New Ticket] => Admin consorcio haciendo pedido para su usuario.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                ...
                case "2":
                  if ($scope.sysLoggedUser.idProfileKf == "3") {
                    console.log(
                      "[New Ticket] => Propietario haciendo pedido a inquilino.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                    ...
                    console.log(
                      "[New Ticket] => Inquilino haciendo pedido a otro inquilino.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                    ...
                    console.log(
                      "[New Ticket] => BSS haciendo pedido a inquilino.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                    ...
                    console.log(
                      "[New Ticket] => Admin consorcio haciendo pedido a inquilino.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
                    ...
                    console.log(
                      "[New Ticket] => Admin consorcio haciendo pedido a otro Admin de consorcio de tipo inquilino.",
                    );
                    $scope.new.ticket.idDepartmentKf =
                      obj.idClientDepartament.idClientDepartament;
                    $scope.new.ticket.idUserRequestBy =
            ...
            case "building":
              switch (obj.radioButtonBuilding) {
                case "1": //PERSONAL DEL EDIFICIO
                  ...
                  $scope.new.ticket.idUserRequestBy =
                    $scope.requestBySelectedUser.idUser;
                  $scope.new.ticket.idUserRequestByProfile =
                    $scope.requestBySelectedUser.idProfileKf;
                  $scope.new.ticket.idUserRequestByTypeTenant =
                    $scope.requestBySelectedUser.idTypeTenantKf;
                  break;
          ...
          if (
            obj.radioButtonBuilding != "4" &&
            obj.radioButtonBuilding != "5"
          ) {
            if (obj.delivery.idTypeDeliveryKf == "1") {
              $scope.new.ticket.idDeliveryTo = null;
              $scope.new.ticket.otherDeliveryAddress = {
                address: null,
                number: null,
                floor: null,
                idProvinceFk: null,
              ...
              if (obj.delivery.whoPickUp.id == undefined) {
                ...
                $scope.new.ticket.idUserDelivery =
                  obj.delivery.deliveryTo.idUser;
                $scope.new.ticket.thirdPersonDelivery = {
                  fullName: null,
                  movilPhone: null,
                  address: null,
                  number: null,
          ...
          $scope.new.ticket.sendNotify =
            $scope.sysLoggedUser.idProfileKf == "1" ? obj.userNotify : null;
          $scope.new.ticket.description = obj.description;
          $scope.new.ticket.costService = NaN2Zero(
            normalizeDecimal(obj.cost.service),
          );
          $scope.new.ticket.costKeys = NaN2Zero(
            normalizeDecimal(obj.cost.keys),
          );
          $scope.new.ticket.costDelivery = NaN2Zero(
            normalizeDecimal(obj.cost.delivery),
          );
          $scope.new.ticket.total = NaN2Zero(normalizeDecimal(obj.cost.total));
          $scope.new.ticket.urlToken = $scope.sysTokenFn(128);
          $scope.new.ticket.autoApproved =
            obj.building.autoApproveAll == "1" ||
            (($scope.new.ticket.idUserRequestByProfile == "3" ||
              $scope.new.ticket.idUserRequestByProfile == "4" ||
              $scope.new.ticket.idUserRequestByProfile == "6") &&
              $scope.new.ticket.idUserRequestByTypeTenant == "1" &&
              obj.building.autoApproveOwners == "1")
              ? 1
              : 0;
          $scope.new.ticket.isNew = 1;
          //HISTORY TICKET CHANGES
          $scope.new.ticket.history = [];
          $scope.new.ticket.history.push({
          ...
          if ($scope.new.ticket.idTypeRequestFor == 1) {
            if (obj.building.autoApproveAll == "1") {
              if (
                (($scope.new.ticket.idUserRequestByProfile == "3" ||
                  ...
                  $scope.new.ticket.idUserRequestByProfile == "6") &&
                  $scope.new.ticket.idUserRequestByTypeTenant == "1" &&
                  obj.idClientDepartament.isAprobatedAdmin == "1") ||
                (($scope.new.ticket.idUserRequestByProfile == "4" ||
                  $scope.new.ticket.idUserRequestByProfile == "5" ||
                  $scope.new.ticket.idUserRequestByProfile == "6") &&
                  $scope.new.ticket.idUserRequestByTypeTenant == "2" &&
                  obj.userRequestBy.isDepartmentApproved == "1")
              ) {
                ...
                if ($scope.sysLoggedUser.idProfileKf == "4") {
                  $scope.new.ticket.history.push({
                    idUserKf: $scope.sysLoggedUser.idUser,
                    descripcion:
                      "Pedido aprobado por la Administración, automaticamente.",
                    idCambiosTicketKf: "2",
                  });
                } else {
                  $scope.new.ticket.history.push({
                    idUserKf: "1",
                    descripcion:
                      "Pedido aprobado por el consorcio, automaticamente, para todos los habitantes.",
                    idCambiosTicketKf: "2",
                  });
                }
              ...
              ($scope.new.ticket.sendNotify == null ||
                $scope.new.ticket.sendNotify == undefined) &&
              (obj.building.autoApproveOwners != null ||
                obj.building.autoApproveOwners == null) &&
              ($scope.new.ticket.idUserRequestByProfile == "3" ||
                $scope.new.ticket.idUserRequestByProfile == "4" ||
                $scope.new.ticket.idUserRequestByProfile == "6") &&
              ...
              if (
                obj.building.autoApproveOwners == "1" &&
                obj.idClientDepartament.isAprobatedAdmin == "1" &&
                (obj.building.mpPaymentMethod != "1" ||
                  obj.building.mpPaymentMethod == "1")
              ) {
                ...
                if ($scope.sysLoggedUser.idProfileKf == "4") {
                  ...
                  $scope.new.ticket.history.push({
                    idUserKf: $scope.sysLoggedUser.idUser,
                    descripcion:
                      "Pedido aprobado por el consorcio, automaticamente, solo para propietarios.",
                    idCambiosTicketKf: "2",
                  });
                }
                if ($scope.new.ticket.total > 0) {
                ...
                (obj.building.autoApproveOwners == null ||
                  obj.building.autoApproveOwners == "0") &&
                obj.building.mpPaymentMethod == "1" &&
                (obj.idClientDepartament.isAprobatedAdmin != "1" ||
                  obj.idClientDepartament.isAprobatedAdmin == "1")
              ) {
                ...
                if (
                  ...
                  $scope.new.ticket.history.push({
                    idUserKf: "1",
                    descripcion: "Pedido aprobado por BSS, automaticamente.",
                    idCambiosTicketKf: "2",
                  });
                  $scope.new.ticket.history.push({
                    idUserKf: "1",
              ...
              $scope.new.ticket.history.push({
                idUserKf: "1",
                descripcion: "Proceso de pago interno.",
                idCambiosTicketKf: "4",
              });
              $scope.new.ticket.history.push({
                idUserKf: "1",
            ...
            if (
              ($scope.new.ticket.status == 3 &&
                obj.building.autoApproveAll == "1" &&
                obj.building.chargeForExpenses == "1" &&
                $scope.new.ticket.idTypePaymentKf == "1") ||
              ($scope.new.ticket.status == 3 &&
                obj.building.autoApproveOwners == "1" &&
                obj.building.chargeForExpenses == "1" &&
                $scope.new.ticket.idTypePaymentKf == "1")
              ...
              if ($scope.new.ticket.total > 0) {
                if ($scope.sysLoggedUser.idProfileKf == "4") {
                  $scope.new.ticket.history.push({
                    idUserKf: "1",
                    descripcion: "Pedido sera pagado por expensas.",
                    idCambiosTicketKf: "4",
                  });
                } else {
                  $scope.new.ticket.history.push({
                  ...
                  $scope.new.ticket.history.push({
                    idUserKf: "1",
                    descripcion:
                      "Pedido sera pagado por expensas, habilitado por el consorcio.",
                    idCambiosTicketKf: "4",
                  });
                }
                $scope.new.ticket.history.push({
              ...
              (obj.building.autoApproveOwners == null ||
                obj.building.autoApproveOwners == "0") &&
              (obj.building.autoApproveAll == null ||
                obj.building.autoApproveAll == "0") &&
              obj.building.chargeForExpenses == "1" &&
              $scope.new.ticket.idTypePaymentKf == "1"
            ) {
              if ($scope.sysLoggedUser.idProfileKf == "4") {
              ...
              $scope.new.ticket.status == 3 &&
              (obj.building.chargeForExpenses == null ||
                obj.building.chargeForExpenses == "1") &&
              $scope.new.ticket.idTypePaymentKf != "1"
            ) {
            ...
            if (
              ...
              ($scope.sysLoggedUser.idProfileKf == "4" &&
                (obj.building.mpPaymentMethod == "1" ||
                  obj.building.mpPaymentMethod != "1") &&
                $scope.new.ticket.idTypePaymentKf == "2") ||
              ($scope.sysLoggedUser.idProfileKf == "1" &&
                (obj.building.mpPaymentMethod == "1" ||
                  obj.building.mpPaymentMethod != "1") &&
                $scope.new.ticket.idTypePaymentKf == "2" &&
              ...
              if (
                ...
                $scope.sysLoggedUser.idProfileKf == "1" &&
                ($scope.new.ticket.total > 0 || $scope.new.ticket.total == 0) &&
                obj.building.mpPaymentMethod == "1" &&
                obj.building.autoApproveAll != "1"
              ) {
                $scope.new.ticket.status = 9;
        ...
        case "down": // SOLOCITUD DE BAJA
          ...
          $scope.new.ticket.mail +=
            '<tr><td align="center" valign="middle"style="width: 15%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Realizado por</td>';
          $scope.new.ticket.mail +=
            '<td align="left" valign="middle" style="width: 35%;font-size: 1vw;">' +
            $scope.sysLoggedUser.fullNameUser +
            ' <span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>' +
            $scope.sysLoggedUser.nameProfile +
            "</b></span></td>";
          ...
          if (obj.optionTypeSelected.name == "department") {
            $scope.new.ticket.mail +=
              '</tr><tr><td align="center" valign="middle" style="width: 15%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Razón / Motivo</td>';
            if (obj.reason == "1") {
              $scope.new.ticket.mail +=
                '<td colspan="3" align="left" valign="middle">' +
                obj.reason_details.reasonDisabledItem +
                '&nbsp<span style="font-size: 0.7vw; background-color:#f2dede;border-color: #ebccd1 !important;color: #a94442 !important; border-radius: 10px; padding: 3px 7px;"><strong>IMPORTANTE: </strong>Si sufrio un robo, por motivos de seguridad comuniquese a nuestro telefono de urgencias <a href="tel:0800">0800-BSS</a></span></td>';
            } else if (obj.reason == "3") {
              $scope.new.ticket.mail +=
                '<td colspan="3" align="left" valign="middle">' +
                obj.reason_details.reasonDisabledItem +
                '&nbsp<span style="font-size: 0.7vw; background-color:#b8c3d2;border-color: #b8c3d2 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><strong>Información: </strong>BSS se pondra en contacto para informarle si el llavero se encuentra en garantía.</span></td>';
            } else {
              $scope.new.ticket.mail +=
          ...
          if (obj.optionTypeSelected.name == "building") {
            $scope.new.ticket.mail +=
              '<td align="center" valign="middle" style="width: 15%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Razón / Motivo</td>';
            if (obj.reason == "1") {
              $scope.new.ticket.mail +=
                '<td colspan="3" align="left" valign="middle">' +
                obj.reason_details.reasonDisabledItem +
                '<span style="font-size: 0.7vw; background-color:#f2dede;border-color: #ebccd1 !important;color: #a94442 !important; border-radius: 10px; padding: 3px 7px;"><strong>IMPORTANTE: </strong>Si sufrio un robo, por motivos de seguridad comuniquese a nuestro telefono de urgencias <a href="tel:0800">0800-BSS</a></span></td>';
            } else if (obj.reason == "3") {
              $scope.new.ticket.mail +=
                '<td colspan="4" align="left" valign="middle">' +
                obj.reason_details.reasonDisabledItem +
                '<span style="font-size: 0.7vw; background-color:#d9edf7;border-color: #bce8f1 !important;color: #31708f !important; border-radius: 10px; padding: 3px 7px;"><strong>Información: </strong>BSS se pondra en contacto para informarle si el llavero se encuentra en garantía.</span></td>';
            } else {
              $scope.new.ticket.mail +=
                '<td colspan="4" align="left" valign="middle">' +
                obj.reason_details.reasonDisabledItem +
          ...
          $scope.new.ticket.mail +=
            ...
            "</td>";
          $scope.new.ticket.mail +=
            '<td align="center" valign="middle" style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;padding-left: 0.4%">Consorcio</td>';
          $scope.new.ticket.mail +=
            '<td align="left" valign="middle">' + obj.building.name + "</td>";
          $scope.new.ticket.mail += "</tr></tbody>";
          /*-- KEYS REQUESTED --*/
          $scope.new.ticket.mail +=
            '<tbody><tr><td align="center" valign="middle" colspan="4" style="background:#427a9d;color:white; padding:0.4%">Llaveros a dar de baja</td></tr>';
          $scope.new.ticket.mail +=
            '<tr><td colspan="4" style="background:#fff;">';
          ...
          $scope.new.ticket.mail += "<thead><tr>";
          $scope.new.ticket.mail +=
            '<th style="vertical-align: middle;text-align: center; background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> N°</th>';
          $scope.new.ticket.mail +=
            '<th style="vertical-align: middle;text-align: center; background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> Llavero</th>';
          $scope.new.ticket.mail +=
            '<th style="vertical-align: middle;text-align: center; background-color: #b8c3d2;border-right: 1px solid #ddd !important; "> Codigo</th>';
          ...
          for (var i = 0; i < $scope.list_keys.length; i++) {
            var idUserKf =
              $scope.list_keys[i].user != undefined
                ...
                : null;
            $scope.new.ticket.keys.push({
              idProductKf: $scope.list_keys[i].key.idProductKf,
              idKeychainKf: $scope.list_keys[i].key.idKeychain,
              idCategoryKf: $scope.list_keys[i].key.idCategoryKf,
              idUserKf: $scope.list_keys[i].key.idUserKf,
              idDepartmenKf: $scope.list_keys[i].key.idDepartmenKf,
              isKeyTenantOnly: $scope.list_keys[i].key.isKeyTenantOnly,
              idClientKf: $scope.list_keys[i].key.idClientKf,
              idClientAdminKf: $scope.list_keys[i].key.idClientAdminKf,
              priceFabric: $scope.list_keys[i].key.priceFabric,
            });
            $scope.new.ticket.mail +=
              '<tr style="align-content: center; cursor: pointer;">';
          ...
          if (
            ...
            if (obj.delivery.idTypeDeliveryKf == "1") {
              ...
              $scope.new.ticket.mail +=
                '<td align="left" style="width: 40%;" valign="middle">Proceso interno ';
              if (
                obj.delivery.whoPickUp != undefined &&
                obj.delivery.whoPickUp != null &&
                ((obj.delivery.idTypeDeliveryKf == 2 &&
                  obj.delivery.idDeliveryTo == 1) ||
                  (obj.delivery.idTypeDeliveryKf == 2 &&
            ...
            if (
              obj.delivery.idTypeDeliveryKf != null &&
              obj.delivery.deliveryTo != null
            ) {
              if (obj.delivery.idTypeDeliveryKf == "1") {
                $scope.new.ticket.mail +=
            ...
            if (obj.delivery.idTypeDeliveryKf == null) {
              $scope.new.ticket.mail +=
                '<td align="left" valign="middle" style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff; padding-left: 0.4%">Procesado por</td>';
              $scope.new.ticket.mail +=
                '<td align="left" style="width: 40%;" valign="middle"><span style="font-size: 0.7vw; background-color:#ffc107;border-color: #ffc107 !important;color: #000 !important; border-radius: 10px; padding: 3px 7px;"><b>BSS</b></span></td>';
            }
            $scope.new.ticket.mail += "</tr></tbody>";
          ...
          $scope.new.ticket.mail +=
            '<td style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;text-align: center;">Gestión</td>';
          $scope.new.ticket.mail +=
            '<td style="width: 15%;"> $ ' + costService + "</td>";
          ...
          $scope.new.ticket.mail +=
            '<td style="width: 10%; background-color: #b8c3d2;font-size: 1vw;color: #fff;text-align: center;">Total</td>';
          $scope.new.ticket.mail +=
            '<td style="width: 15%;"> $ ' + costTotal + "</td>";
          $scope.new.ticket.mail += "</tr></tbody></table>";
          $scope.new.ticket.mail += "</td>";
          /*--  COSTS --*/
          $scope.new.ticket.mail += "</tr></tbody>";
          ...
          $scope.new.ticket.idTypePaymentKf =
            obj.cost.total > 0 ? obj.cost.idTypePaymentKf : null;
          $scope.new.ticket.sendNotify =
            $scope.sysLoggedUser.idProfileKf == "1" ? obj.userNotify : null;
          $scope.new.ticket.description = obj.description;
          $scope.new.ticket.costService = NaN2Zero(
    ...
    $scope.addUpRequestFn = function (pedido) {
      ...
      ticketServices.addUpRequest(pedido).then(function (response) {
        ...
        if (response.status == 200) {
          ...
          if (
            (response.data.response.idStatusTicketKf == "3" ||
              response.data.response.idStatusTicketKf == "9") &&
            response.data.response.idTypePaymentKf == "2" &&
            response.data.response.total > 0
          ) {
            $timeout(function () {
    ...
    $scope.addDownRequestFn = function (pedido) {
      ...
      ticketServices.addDownRequest(pedido).then(function (response) {
        ...
        if (response.status == 200) {
          ...
          if (
            (response.data.idStatusTicketKf == "3" ||
              response.data.idStatusTicketKf == "9") &&
            response.data.idTypePaymentKf == "2" &&
