    ...
    **************************************************/
        ...
        $scope.modalConfirmation = function(opt, confirm, obj){
          ...
          switch ($scope.swMenu){
              ...
              case "cancel_user":
                if (confirm==0){
                  if ((obj.isKeysEnable=="1" || obj.isKeysEnable=="0" || obj.isKeysEnable==null) && obj.idMgmtMethodKf !=null && (obj.building.iporsStockInOffice==null || obj.building.iporsStockInOffice=="1" || obj.building.isStockInBuilding==null || obj.building.isStockInBuilding=="1")){
