      ...
      **************************************************/
        ...
        **************************************************/
          ...
          $scope.profileUserOpen = function(){
            ...
            $scope.select.phoneCountryWired.selected    = phoneParsedLocal==null?$scope.countryPhoneCodesList.find(c => c.isoCode === "AR"):$scope.countryPhoneCodesList.find(c => c.isoCode === phoneParsedMovil.countryCodeTmp.isoCode);
