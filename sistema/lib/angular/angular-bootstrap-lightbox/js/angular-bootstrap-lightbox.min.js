...
angular.module('bootstrapLightbox').provider('Lightbox', function () {
  ...
  this.getImageUrl = function (image) {
    return typeof image === 'string' ? image : image.urlFile;
  };
